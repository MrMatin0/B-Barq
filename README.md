...
B-Barq در حال حاضر از Yandex AppMetrica استفاده می‌کند برای پیدا کردن خطاها و باگ‌ها  این سرویس ممکن است مطابق سیاست حریم خصوصی خود، برخی اطلاعات پایه مربوط به دستگاه و نحوه استفاده از برنامه را جمع‌آوری کند. B-Barq عمداً اطلاعات شخصی مانند شماره تلفن یا شناسه قبض را به AppMetrica ارسال نمی‌کند.

ممکن است در یک به‌روزرسانی آینده، در صورت عدم نیاز، AppMetrica به‌طور کامل حذف شود.
## مشارکت
